        ...
        <aside className="w-64 shrink-0 border-r border-white/10 bg-[#0a0a0f]/80 backdrop-blur-xl sticky top-0 h-screen overflow-y-auto">
            <div className="py-6 px-4">
                ...
                <Link href="/" className="flex items-center gap-2 mb-8 group">
                    <div className="w-8 h-8 rounded-lg bg-linear-to-br from-blue-500 to-teal-500 flex items-center justify-center">
                ...
                <div className="mt-8 pt-6 border-t border-white/10">
                    <div className="px-3 py-3 rounded-lg bg-linear-to-r from-blue-500/10 to-teal-500/10 border border-blue-500/20">
                        <p className="text-xs text-gray-400">
                            <span className="text-blue-400 font-semibold">v2.0</span> · Last updated January 2026
                        </p>
                    </div>
                </div>
            </div>
